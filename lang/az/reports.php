...
return [
    ...
    'margin' => [
        ...
        'cash_title'    => 'Kassa (faktiki)',
        'cash_hint'     => 'təsdiqlənmiş ödənişlər üzrə',
        'kpi_received'   => 'Agentliklərdən daxil olub',
        'kpi_paid_out'   => 'Təchizatçılara ödənilib',
        'kpi_receivable' => 'Alınacaq (debitor)',
        'kpi_payable'    => 'Ödəniləcək (kreditor)',
