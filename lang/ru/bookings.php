...
return [
    ...
    'show' => [
        ...
        'proof_card'    => 'Подтверждение оплаты',
        'proof_empty'   => 'Агентство ещё не прикрепило подтверждение оплаты.',
        'proof_uploaded' => 'Загружено :date',
    ...
    'agency_show' => [
        ...
        'payment' => [
            'title'       => 'Оплата',
            'confirmed'   => 'Бронь подтверждена. Ожидайте счёт от оператора.',
            'awaiting'    => 'Оператор выставил счёт.',
            'paid'        => 'Оплачено. Идёт подготовка к поездке.',
            'in_progress' => 'Тур идёт. Хорошей поездки!',
            'completed'   => 'Тур завершён. Спасибо, что выбрали нас!',
            'cancelled'   => 'Бронирование отменено.',
        ],
        'files'            => 'Файлы',
        'proof' => [
            'title'    => 'Подтверждение оплаты',
            'hint'     => 'Прикрепите чек или платёжное поручение — оператор подтвердит оплату.',
            'upload'   => 'Загрузить файл',
            'empty'    => 'Файлы пока не прикреплены.',
            'uploaded' => 'Загружено :date',
            'delete'   => 'Удалить',
            'success'  => 'Подтверждение оплаты загружено',
            'deleted'  => 'Файл удалён',
