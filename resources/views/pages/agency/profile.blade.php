                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="d-flex gap-2">
                            <button type="button" id="btn-avatar-upload" class="btn btn-sm btn-light-success">
                                <span class="indicator-label"><i class="ki-outline ki-cloud-add fs-5 me-1"></i>{{ __('profile.avatar.upload') }}</span>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content">
            <div class="modal-header border-0 pb-0">
                <h5 class="fw-bold">{{ __('profile.avatar.delete_confirm') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body text-muted py-3">
                {{ __('profile.avatar.delete_body') }}
            </div>
